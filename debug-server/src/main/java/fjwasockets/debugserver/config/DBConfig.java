package fjwasockets.debugserver.config;
...
@EnableJpaRepositories("fjwasockets.debugserver.repository")
public class DBConfig implements TransactionManagementConfigurer {
    ...
    enum DB {
        LOCAL("jdbc:mysql://localhost:3307/debug_server",
                "root", "password");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "fjwasockets.debugserver.model" });
